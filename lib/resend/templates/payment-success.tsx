      ...
      <Body className='bg-[#f6f8fc] py-8 font-sans text-[#0f172a]'>
        <Container className='mx-auto max-w-140 rounded-2xl bg-white px-8 py-10 shadow-[0_8px_40px_rgba(15,23,42,0.08)]'>
          <Section className='mb-8 rounded-xl bg-linear-to-r from-cyan-500 to-blue-600 px-6 py-6 text-white'>
            <Text className='m-0 text-[14px] uppercase tracking-[0.12em] opacity-85'>Payment Received!</Text>
            <Text className='m-0 mt-2 text-[30px] leading-9 font-semibold'>Your Protap Digital Asset is ready!</Text>
            <Text className='m-0 mt-3 text-[15px] leading-5.5 opacity-90'>
              Thanks {customerName}, your {planLabel} purchase is complete and your digital profile experience is ready.
            </Text>
          </Section>
          ...
          <Section className='rounded-xl border border-[#e2e8f0] bg-[#f8fafc] px-5 py-4'>
            ...
            <Text className='m-0 mt-2 text-[13px] leading-5 text-[#475569]'>
              Reference: <strong>{purchaseReference}</strong>
            </Text>
            {cardId ? (
              <Text className='m-0 mt-2 text-[13px] leading-5 text-[#475569]'>
            ...
            <Text className='m-0 mt-2 text-[13px] leading-5 text-[#475569]'>
              ...
              <strong>
                {activatedAccount
                  ...
                  : 'A new Protap card has been added to your account.'}
              </strong>
            </Text>
          </Section>
          ...
          <Text className='mb-0 mt-8 text-[14px] leading-5.5 text-[#334155]'>
            We are excited to have you on board. If you need help getting set up, just reply to this email and our team
            will assist right away.
          </Text>

          <Section className='my-7 border-[#e2e8f0]' />

          <Text className='m-0 text-[12px] leading-4.5 text-[#64748b]'>
            Protap · Smart NFC business cards and digital profiles
          </Text>
        </Container>
      </Body>
    </Container>
